...
func _process(_delta):
	...
	if state == "collected":	$AnimatedSprite.animation = "collected"
	if state == "collectable":	$AnimatedSprite.animation = "collectable"
	if state == "focus":	$AnimatedSprite.animation = "focus"
