...
#Sets the new speed and slower speed depending on speed sensitivity
func on_speed_sensitivity(new_speed):
	speed = new_speed
	if speed == 120:	slower_speed = 95
	elif speed == 100:	slower_speed = 75
	elif speed == 80:	slower_speed = 55
	elif speed == 60:	slower_speed = 35
	elif speed == 40:	slower_speed = 15
