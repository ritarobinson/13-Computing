...
#User Customisations
func _ready():
	#sets players speed based on sensitivity in Settings Menu
...
#Sets player speed to slower speed if health = 2, connected in PlayerResource script
...
func _physics_process(delta):
	...
	for index in get_slide_count():
		...
		var body_collider = body_name.split("2", true, 1)
		var enemy_collider = body_collider[0]
		#if collision body is Enemy,
